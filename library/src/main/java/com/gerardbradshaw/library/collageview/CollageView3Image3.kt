...
class CollageView3Image3(context: Context, attrs: AttributeSet?,
  ...
  private fun resizeImage0(deltaWidth: Float) {
    ...
    imageParamsCache[2].width = imageParamsCache[1].width
    imageParamsCache[2].x = imageParamsCache[1].x
  ...
  private fun resizeImage2(deltaWidth: Float, deltaHeight: Float) {
    ...
    imageParamsCache[0].width = layoutWidth - imageParamsCache[2].width

    imageParamsCache[1].width = imageParamsCache[2].width
    imageParamsCache[1].height = imageParamsCache[2].height
    imageParamsCache[1].y = layoutHeight - imageParamsCache[2].height
