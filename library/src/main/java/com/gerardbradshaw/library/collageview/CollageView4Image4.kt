...
class CollageView4Image4(context: Context, attrs: AttributeSet?,
  ...
  private fun resizeImage0(deltaWidth: Float, deltaHeight: Float) {
    ...
    imageParamsCache[3].height = layoutHeight - imageParamsCache[0].height
    imageParamsCache[3].y = imageParamsCache[0].height
  ...
  private fun resizeImage2(deltaWidth: Float, deltaHeight: Float) {
    ...
    imageParamsCache[1].height = layoutHeight - imageParamsCache[2].height

    imageParamsCache[3].width = layoutWidth - imageParamsCache[2].width
    imageParamsCache[3].height = imageParamsCache[2].height
    imageParamsCache[3].x = imageParamsCache[2].width
    imageParamsCache[3].y = imageParamsCache[2].y
  ...
  private fun resizeImage3(deltaWidth: Float, deltaHeight: Float) {
    ...
    imageParamsCache[0].height = layoutHeight - imageParamsCache[3].height

    imageParamsCache[1].height = layoutHeight - imageParamsCache[3].height

    imageParamsCache[2].width = layoutWidth - imageParamsCache[3].width
    imageParamsCache[2].height = imageParamsCache[3].height
    imageParamsCache[2].y = imageParamsCache[3].y
  ...
  companion object {
    private const val TAG = "CollageView4Image4"
  }
}